...
public class CoinsEnginePlugin extends NightPlugin {
    ...
    public void enable() {
        ...
        this.snapshotCache = new su.nightexpress.excellenteconomy.data.BalanceSnapshotCache();
        ...
        if (Config.isMigrationEnabled()) {
            this.migrationManager = new MigrationManager(this, this.dataHandler, this.userManager,
                    this.currencyRegistry, this.currencyManager);
    ...
    public void disable() {
        ...
        if (this.topManager != null)
            this.topManager.shutdown();
