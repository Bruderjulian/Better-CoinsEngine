...
public abstract class AbstractCurrency implements Currency, ConfigBacked {
    ...
    public AbstractCurrency(Path path, String id) {
        this.path = path;
        this.id = id;
    ...
    private void load(FileConfig config) throws IllegalStateException {
        this.setName(ConfigValue.create("Name", StringUtil.capitalizeUnderscored(this.id),
                "Currency display name.",
                Placeholders.URL_WIKI_TEXT).read(config));
        ...
        this.setPrefix(ConfigValue.create("Prefix", this.name,
                ...
                Placeholders.WIKI_PREFIXES).read(config));
        ...
        this.setCommandAliases(ConfigValue.create("Command_Aliases", new String[] { this.id },
                ...
                Placeholders.WIKI_COMMANDS).read(config));

        this.setIcon(ConfigValue.create("Icon",
                NightItem.fromType(Material.GOLD_NUGGET),
                "Currency icon.",
                Placeholders.URL_WIKI_ITEMS).read(config));
        ...
        this.setColumnName(ConfigValue.create("Column_Name", this.id,
                ...
                Placeholders.WIKI_CROSS_SERVER).read(config));
        ...
        this.setDecimal(ConfigValue.create("Decimal", false,
                "Controls whether decimal values are allowed for this currency.").read(config));
        ...
        this.setExchangeAllowed(ConfigValue.create("Exchange.Allowed",
                ...
                Placeholders.WIKI_EXCHANGE).read(config));
        ...
        this.leaderboardEnabled = ConfigValue.create("Leaderboard.Enabled",
                ...
                Placeholders.WIKI_TOPS).read(config);
    ...
    public boolean hasPermission(Player player) {
        return !this.permissionRequired
                || (player.hasPermission(this.getPermission()) || player.hasPermission(Perms.CURRENCY));
    }
    ...
    private String getFormatted(String originalFormat, double balance,
        ...
        return this.replacePlaceholders().apply(originalFormat).replace(Placeholders.GENERIC_AMOUNT,
                valueFormatter.apply(balance));
    }
    ...
    public void setColumnName(String dataColumn) {
