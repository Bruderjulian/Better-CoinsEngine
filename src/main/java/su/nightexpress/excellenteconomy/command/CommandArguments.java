...
public class CommandArguments {
    ...
    @NotNull
    public static su.nightexpress.nightcore.commands.builder.ArgumentNodeBuilder<String> crossServerPlayerName(@NotNull su.nightexpress.excellenteconomy.CoinsEnginePlugin plugin) {
