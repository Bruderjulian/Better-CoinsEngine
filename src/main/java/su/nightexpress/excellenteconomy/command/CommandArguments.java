...
public class CommandArguments {
    ...
    public static ArgumentNodeBuilder<Currency> currency(CurrencyRegistry registry) {
        return Commands
                .argument(CURRENCY,
                        (context, string) -> registry.byId(string)
                                .orElseThrow(() -> CommandSyntaxException.custom(Lang.COMMAND_SYNTAX_INVALID_CURRENCY)))
    ...
    public static su.nightexpress.nightcore.commands.builder.ArgumentNodeBuilder<String> crossServerPlayerName(
        ...
        return Arguments.playerName(PLAYER)
                ...
                .suggestions((reader, context) -> {
                    ...
                    if (sender != null)
                        names.addAll(su.nightexpress.nightcore.util.Players.playerNames(sender));
