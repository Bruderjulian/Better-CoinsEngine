...
public abstract class CurrencyCommandProvider extends AbstractCommandProvider {
    ...
    public CurrencyCommandProvider(@NotNull ExcellentEconomyPlugin plugin, @NotNull CurrencyRegistry registry,
            @NotNull CurrencyManager manager, @NotNull String name) {
        super(plugin, name);
