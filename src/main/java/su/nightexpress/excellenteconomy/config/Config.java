...
import static su.nightexpress.excellenteconomy.Placeholders.CURRENCY_PREFIX;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_MIGRATION;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_PLACEHOLDERS;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_PREFIXES;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_TOPS;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_VAULT_HOOK;
import static su.nightexpress.excellenteconomy.Placeholders.WIKI_WALLET;
...
public class Config {
        ...
        public static final ConfigValue<Boolean> INTEGRATION_VAULT_ENABLED = ConfigValue.create(
                        "Integration.Vault.Enabled",
                        true,
        ...
        public static final ConfigValue<Integer> REDIS_BALANCE_SYNC_INTERVAL = ConfigValue.create(
                        "Redis.Sync.Balance_Interval",
                        30,
        ...
        public static final ConfigValue<Integer> REDIS_LEADERBOARD_SYNC_INTERVAL = ConfigValue.create(
                        "Redis.Sync.Leaderboard_Interval",
                        300,
        ...
        public static final ConfigValue<Boolean> REDIS_SYNC_TRANSACTION_LOGS = ConfigValue.create(
                        "Redis.Sync.Transaction_Logs",
                        true,
                        "Enable synchronization of currency operation logs.");

        public static final ConfigValue<Boolean> EXPERIMENTAL_AUTO_REGISTER_USERS = ConfigValue.create(
                        "Experimental.Auto_Register_Users",
                        false,
